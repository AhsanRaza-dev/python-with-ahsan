# String Slicing
a = "Ahsan Raza your python instructor"
print(a[0:6]) # to print Ahsan
print(a[6:11]) # to print Raza
print(a[1:]) # to print hsan Raza your python instructor skipping the A
